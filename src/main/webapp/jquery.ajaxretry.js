...
(function($) {
    var NOP_FUNC = function(){},
        ...
        DEF_ERROR_CODES = [400, 401, 402, 403, 502, 503, 504],
        DEF_SLOT_TIME = 1000,
        DEF_OPTS = {
        ...
        ajaxWithRetry = function(settings){
            ...
            function checkIfErrorStatusCode(httpStatus) {
                return 0 <= $.inArray(httpStatus, opts.error_codes);
            }

            settings.error = function(xhr_obj, textStatus, errorThrown){
                var can_retry = checkIfErrorStatusCode(xhr_obj.status) || textStatus === 'error';
                failures++;
