...
public class PromotionStatusProviderTest {
    ...
    public void testIsBuildPromotedWhenThereArePromotions() {
        ...
        final PromotionStatusProvider.PromotedBuildActionWrapper mockPromotedBuildActionWrapper =
                mock(PromotionStatusProvider.PromotedBuildActionWrapper.class);
        when(mockPromotedBuildActionWrapper.getPromotions(any(Object.class))).thenReturn(mockPromotionList);
    ...
    public void testGetPromotionStatusList() {
        ...
        when(mockPromotionStatusWrapper.getPromotionBuilds(any(Object.class))).thenReturn(mockPromotions);
        ...
        final PromotionStatusProvider.PromotedBuildActionWrapper mockPromotedBuildActionWrapper =
                mock(PromotionStatusProvider.PromotedBuildActionWrapper.class);
        when(mockPromotedBuildActionWrapper.getPromotions(any(Object.class))).thenReturn(mockStatusList);
