...
public class PipelineFactoryTest {
    ...
    public void testExtractPipeline() throws Exception {
        ...
        assertEquals(pipeline,
                new Pipeline("Piper", null, null, null, null, null,
                        asList(new Stage("Build", asList(new Task("comp", "Compile", null, idle(), "", false, null, null)), null),
                                new Stage("Test", asList(new Task("test", "Test", null, idle(), "", false, null, null)), null),
                                new Stage("Deploy", asList(new Task("deploy", "Deploy", null, idle(), "", false, null, null)), null)), false));
    ...
    public void testCreatePipelineLatest() throws Exception {
        ...
        assertEquals(new Pipeline("Pipeline", null, null, null, null, null, asList(new Stage("Build", asList(new Task("build", "build", null, idle(), null,false, null, null)), null)), false), PipelineFactory.extractPipeline("Pipeline", build));
        ...
        assertEquals(new Pipeline("Pipeline", null, null, null, null, null, asList(new Stage("Build", asList(new Task("build", "build", null, idle(), null, false, null, null), new Task("sonar", "Sonar",null, idle(), null, false, null, null)), null), new Stage("CI", asList(new Task("deploy", "Deploy", null, idle(), null, false, null, null)), null)), false), pipeline);
        jenkins.buildAndAssertSuccess(build);
        jenkins.waitUntilNoActivity();
