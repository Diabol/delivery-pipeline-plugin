...
exports.getJQueryUI = function() {
    return $ui;
		...
		require('jenkins-js-modules').export('jquery-detached', 'jqueryui1', module);
		require('jenkins-js-modules').addModuleCSSToPage('jquery-detached', 'jqueryui1');
    });

},{"jenkins-js-modules":2,"jqueryui-detached-1.11/decorator":5}],2:[function(require,module,exports){
